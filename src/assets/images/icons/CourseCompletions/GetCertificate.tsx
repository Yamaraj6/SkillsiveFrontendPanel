...
function GetCertificate({ className }: ISvgProps) {
	return (
		<svg className={className} xmlns='http://www.w3.org/2000/svg' width='19.169' height='19.586' viewBox='0 0 19.169 19.586'>
			<defs>
				<style>{'.GetCertificateA,.GetCertificateB{fill:#fff;}.GetCertificateA{opacity:0.404;}'}</style>
			</defs>
			<g transform='translate(-5.415 -5)'>
				<circle className='GetCertificateA' cx='8' cy='8' r='8' transform='translate(7 5)' />
				<path
					className='GetCertificateB'

...
import * as sty from './PlasmicInput.module.css'; // plasmic-import: EI2IZZAvPf/css
...
type NodeOverridesType<T extends NodeNameType> = Pick<PlasmicInput__OverridesType, DescendantsType<T>>;
